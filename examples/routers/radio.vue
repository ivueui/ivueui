<template>
    <div>
        ...
        <Radio size="large" v-model="single" disabled>Radio</Radio>
        <Radio size="default" v-model="single" disabled>Radio</Radio>
        <Radio size="small" v-model="single" disabled>Radio</Radio>
        
        
        <Radio size="large" disabled>Radio</Radio>
        <Radio size="default" disabled>Radio</Radio>
        <Radio size="small" disabled>Radio</Radio>
