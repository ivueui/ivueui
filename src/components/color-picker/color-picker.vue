<template>
    <div :class="classes" v-clickoutside="handleClose">
        <div ref="reference" @click="toggleVisible" :class="wrapClasses">
            ...
            <i class="one-icon one-icon-arrow-down-b one-input-icon one-input-icon-normal"></i>
            <div :class="inputClasses">
                <div :class="[prefixCls + '-color']">
                    <div :class="[prefixCls + '-color-empty']" v-show="value === '' && !visible">
                        <i class="one-icon one-icon-ios-close-empty"></i>
                    </div>
        ...
        <transition :name="transition">
            <Drop
                ...
                class-name="one-transfer-no-max-height"
                :placement="placement"
                ref="drop"
...
<script>
    ...
    const prefixCls = 'one-color-picker';
    const inputPrefixCls = 'one-input';
