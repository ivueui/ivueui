    ...
    <div :class="classes" v-clickoutside="handleClose">
        <div
            ...
            <slot name="input">
                ...
                <div class="one-tag" v-for="(item, index) in selectedMultiple">
                    <span class="one-tag-text">{{ item.label }}</span>
        ...
        computed: {
            ...
            dropdownCls () {
                return {
                    ...
                    ['one-auto-complete']: this.autoComplete,
                };
            },
            selectionCls () {
                return {
